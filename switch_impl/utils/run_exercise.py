...
class ExerciseRunner:
    ...
    def __init__(self, topo_file, log_dir, pcap_dir,
        ...
        self.logger('switch_json: %s, bmv2_exe: %s' % (switch_json, bmv2_exe))
    ...
    def create_network(self):
        ...
        self.net = Mininet(topo=self.topo,
                           ...
                           controller=None)
        Intf(name='eth1', node=self.net.switches[0], port=2)
        Intf(name='eth3', node=self.net.switches[0], port=4)
        Intf(name='eth4', node=self.net.switches[1], port=4)
        Intf(name='eth2', node=self.net.switches[1], port=2)
